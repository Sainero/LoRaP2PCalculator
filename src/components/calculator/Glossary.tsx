      ...
      <section className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 border border-slate-100">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { k: 'Low Data Rate Opt. (LDRO)', v: 'Автовключение', d: 'Включается автоматически при времени символа > 16.38 мс (обычно SF11/SF12 на 125 кГц). Компенсирует дрейф частоты опорного генератора на низких скоростях. На SX1262 (наш dongle) активируется чипом автоматически.' },
            ].map((i) => (
